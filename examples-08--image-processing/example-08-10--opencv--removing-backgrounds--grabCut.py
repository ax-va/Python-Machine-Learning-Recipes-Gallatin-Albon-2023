...
cv2.imwrite(
    'example-08-10-1--opencv--removing-backgrounds--grabCut.jpg',
    mask_mapped,
)
...
cv2.imwrite(
    'example-08-10-2--opencv--removing-backgrounds--grabCut.jpg',
    new_mask * 255,
)
# 0 * 255 = 0 (black)
# 1 * 255 = 255 (white)
...
cv2.imwrite(
    'example-08-10-3--opencv--removing-backgrounds--grabCut.jpg',
